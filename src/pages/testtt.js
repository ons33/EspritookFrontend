                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="rounded-3 overflow-hidden mb-2" style={{ height: '250px', width: '100%', zIndex:999}}>
                                                        <ReactMapGl
                                                            {...viewport}
                                                            mapboxAccessToken={Token}
                                                            mapStyle="mapbox://styles/ons3399/clx22cvow004j01qsfb734s07"
                                                            onViewportChange={(viewport) => setViewport(viewport)}
                                                            onDbClick={handleClick}
                                                        >
                                                            {newPlace ? (
                                                                <>
                                                                <Marker latitude={newPlace?.latitude} longitude={newPlace?.longitude}
                                                                offsetLeft={-3.5 * viewport.zoom}  offsetTop={-7 * viewport.zoom}
                                                                >
